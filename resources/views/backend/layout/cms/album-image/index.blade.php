@extends('backend.app', ['title' => 'Upcomming Album'])
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center">Upcomming Album</h4> <hr>
                        <div style="display: flex;justify-content: end;"><a
                                href="{{ route('upcomming.album.create') }}" class="btn btn-primary">Create New</a></div>
